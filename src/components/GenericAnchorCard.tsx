...
function GenericAnchorCard(props: GenericAnchorCardProps) {
  ...
  return (
      <a
        ...
        rel="noreferrer"
      >
        <span className={`flex text-[3rem] items-center justify-center gap-4 dark:text-white font-bold dark:group-hover:text-${color}-400 group-hover:text-${color}-700 w-[400px] sm:w-[300px]`}>
          {icon}{title}
        </span>
